...
### `tools/selftest_all.py` — Comprehensive Self-Test

**Purpose**: Run full test suite (config parsing, tunnel test, IP check, doctor) with formatted report.
...
| `selftest.bat` | `python -m tools.selftest_all` | Run comprehensive self-test |
| `test.bat` | `python -m unittest discover tests` | Run unit tests |
